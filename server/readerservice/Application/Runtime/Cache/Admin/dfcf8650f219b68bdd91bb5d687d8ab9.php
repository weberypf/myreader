...
<head>
    ...
    <title>Reader Service Admin | Log in</title>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="/readerservice/Public/plugins/iCheck/square/blue.css">
...
<div class="login-box">
    <div class="login-logo">
        <a href="#"><b>Reader Service</b>Admin</a>
    </div>
    <!-- /.login-logo -->
...
<!-- jQuery 2.1.4 -->
<script src="/readerservice/Public/plugins/jQuery/jQuery-2.1.4.min.js"></script>
<!-- Bootstrap 3.3.5 -->
